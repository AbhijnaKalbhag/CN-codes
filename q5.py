# 5. Capturing Wireless Control Traffic in Mininet-WiFi
#    - Create a Mininet-WiFi topology with two access points and three mobile stations. 
# Set up a packet capture mechanism to monitor and record wireless control traffic such as beacons, 
# probe requests, and responses. Analyse the captured traffic to understand the wireless communication process.
import sys
