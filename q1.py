# 1. Custom Topology Creation in Mininet
#   - Design and implement a custom network topology in Mininet that includes at least three switches and six hosts.
#Ensure that the topology allows for redundant paths between switches and demonstrate how to test the connectivity between all hosts.
import sys
