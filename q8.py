# 8. Performance Evaluation of a Web Server in a Wireless Network
#     - Create a wireless network topology in Mininet-WiFi with one host acting as a web server and multiple mobile clients accessing the server.
# Evaluate the performance of the web server under different conditions, such as varying client mobility patterns and network load, and report the results.
#!/usr/bin/python
