# 4. 802.11 Wireless LAN Emulation
#    - Implement an 802.11 wireless LAN using Mininet-WiFi with multiple access points and mobile stations.
# Emulate a realistic environment where stations move between different access points and demonstrate how handoff occurs.
