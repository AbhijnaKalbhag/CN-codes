# 6. Handling Multiple Access Points
#    - Design a network topology in Mininet-WiFi with three access points and six mobile stations. 
# Ensure that the stations can roam between access points without losing connectivity. Implement mechanisms to monitor and demonstrate seamless handover between access points.
#!/usr/bin/python
